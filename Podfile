...
post_install do |installer|
  ...
  if Dir.exists?('GestureGame/Resources/Settings.bundle') && File.exists?(acknowledgements_plist)
    FileUtils.cp(acknowledgements_plist, 'GestureGame/Resources/Settings.bundle/Acknowledgements.plist')
  end
end
